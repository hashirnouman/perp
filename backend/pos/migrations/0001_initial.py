    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(default=None, max_length=255, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Customers',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variant', models.CharField(default=None, max_length=255)),
                ('category_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='pos.categories')),
            ],
        ),
        migrations.CreateModel(
            name='MedicineStock',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_category', models.CharField(default=None, max_length=255, unique=True)),
                ('category_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='pos.categories')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drug_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pos.drugs')),
                ('order_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pos.orders')),
            ],
        ),
    ]
